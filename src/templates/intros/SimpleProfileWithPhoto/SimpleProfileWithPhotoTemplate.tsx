...
export const SimpleProfileWithPhotoTemplate = ({
  name,
  profilePhoto,
  title,
  cta,
          ...
          <div className="flex max-w-xs flex-col items-center justify-center rounded-xl py-10 dark:bg-gray-900 dark:text-gray-100 md:p-6 md:px-12 ">
            ...
            <div className="space-y-4 divide-y divide-gray-700 text-center">
              ...
              <div className="align-center flex justify-center space-x-4 pt-2">
                {socialMedia.github && <GitHubLink url={socialMedia.github} />}
                {socialMedia.dribbble && (
                  <DribbbleLink url={socialMedia.dribbble} />
                )}
                {socialMedia.twitter && (
                  <TwitterLink url={socialMedia.twitter} />
                )}
                {socialMedia.email && <EmailLink email={socialMedia.email} />}
              </div>
            </div>
          </div>
        </div>
...
export const DribbbleLink = ({ url }: { url: string }) => (
  <a
    rel="noopener noreferrer"
    href={url}
    aria-label="Dribble"
...
export default SimpleProfileWithPhotoTemplate;
